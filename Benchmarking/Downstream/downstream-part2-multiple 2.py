...
# Global variables
file = 'SPRINT_data.json' # Change accordingly ############################################################
aligners = ['bwa', 'hisat2'] # ['bwa', 'hisat2'] or ['bwa', 'hisat2', 'star']
...
with open ('SPRINT_multiple_Excel.csv', 'a') as excel: # Change accordingly ############################################################
    for align in aligners:
        for condition in conditions:
            for support in supports:
...
with open("SPRINT_multiple_data.json" , 'w') as fp: # Change accordingly  ############################################################
